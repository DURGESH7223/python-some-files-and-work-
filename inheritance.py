...
class Shapes(Rectangle,Square,Circle,Cube,Triangle):
    def __init__(self):
...
#    elif z==2:
#        n=int(input('enter the times to find square details: '))
#        for i in range(n):
#            a=int(input('enter the side of square: '))
#            alpha.s_set(a)
#            print('Square Side:',alpha.s_get())
#            print('Square Area:',alpha.s_area())
#            print('Square Perimeter:',alpha.s_perimeter())
#    elif z==3:
#        n=int(input('enter the times to find rectangle details: '))
#        for i in range(n):
#            a=int(input('enter the length of rectangle: '))
#            b=int(input('enter the width of rectangle: '))
#            alpha.r_set(a,b)
#            print('Rectangle Length & Width:',alpha.r_get())
#            print('Rectangle Area:',alpha.r_area())
#            print('Rectangle Perimeter:',alpha.r_perimeter())
#    
#    elif z==4:
#        n=int(input('enter the times to find circle details: '))
#        for i in range(n):
#            a=int(input('enter the radius of circle: '))
#            alpha.c_set(a)
#            print('Circle Radius:',alpha.c_get())
#            print('Circle Area:',alpha.c_area())
#            print('Circle Perimeter:',alpha.c_perimeter())
#    elif z==0:
#        break
